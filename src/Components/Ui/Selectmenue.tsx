...
import { CategData } from '../Data/data'
import { Icateg } from '../Shared_Interfaces/Interfavess'
                    ...
                    {({ selected, active }) => (
                      <>
                        <div className="flex items-center">
                          <img src={categ.imageURL} alt="" className="h-5 w-5 flex-shrink-0 rounded-full" />
                          <span
